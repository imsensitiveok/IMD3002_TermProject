...
def setUpBlockCreation(customWidth = True, customHeight = True, customDepth = True, widthVar = '', heightVar = '', depthVar = '', colourVar = '', setWidth = 0, setHeight = 0, setDepth = 0, name='Block'):
    ...
    block.namespace = createNamespace(name)
...
def createNamespace(name):
    ...
    namespace = name + str(rnd.randint(1000, 9999))
...
def jumperBlock():
    ...
    block = setUpBlockCreation(customWidth = True, customHeight = True, customDepth = True, widthVar = 'jumperWidth', heightVar = 'jumperHeight', depthVar = 'jumperDepth', colourVar = 'jumperColour', name='jumperBlock')
...
def fourSideBlock():
    ...
    # Setting up to create block
    block = setUpBlockCreation(customWidth = True, customHeight = True, customDepth = True, widthVar = 'fourSideWidth', heightVar = 'fourSideHeight', depthVar = 'fourSideDepth', colourVar = 'fourSideColour', name='fourSideBlock')
...
def roundBlock():
    ...
    # Setting up to create block
    block = setUpBlockCreation(customWidth = False, customHeight = False, customDepth = False, colourVar = 'roundColour', setWidth = 1, setHeight = 1, setDepth = 1, name='roundBlock')
...
def thinJumperBlock():
    ...
    # Setting up to create block
    block = setUpBlockCreation(customWidth = True, customHeight = True, customDepth = False, widthVar = 'thinJumperWidth', heightVar = 'thinJumperHeight', colourVar = 'thinJumperColour', setDepth = 1, name='thinJumperBlock')
...
def cornerBlock():
    ...
    block = setUpBlockCreation(customWidth = False, customHeight = True, customDepth = False, heightVar = 'cornerHeight', colourVar = 'cornerColour', setWidth = 2, setDepth = 1, name='cornerBlock')
...
def shelfBlock():
    ...
    block = setUpBlockCreation(customWidth=False, customHeight=False, customDepth=False, colourVar='shelfColour', setWidth=4, setHeight=2, setDepth=1, name='shelfBlock')
...
def sixBumpBlock():
    ...
    block = setUpBlockCreation(customWidth=False, customHeight=False, customDepth=False, colourVar='sixBumpColour', setWidth=2, setHeight=3, setDepth=1, name='sixBumpBlock')
...
# -------------------------------------------------------------------------------------
def fourBumpBlock():
    block = setUpBlockCreation(customWidth=False, customHeight=False, customDepth=False, colourVar='fourBumpColour', setWidth=2, setHeight=1, setDepth=1.5, name='fourBumpBlock')
...
window = cmds.window(WINDOW_NAME, menuBar = True, widthHeight=(500,300))
cmds.scrollLayout()
...
cmds.frameLayout(collapsable = True, label = 'Standard Block', width = 475)
cmds.columnLayout()
...
# Layout: Tile Block
cmds.frameLayout(collapsable = True, label = 'Tile Block', width = 475)
cmds.columnLayout()
...
# Layout: Jumper Block
cmds.frameLayout(collapsable = True, label = 'Jumper Block', width = 475)
cmds.columnLayout()
...
cmds.frameLayout(collapsable = True, label = '4 Sided Block', width = 475)
cmds.columnLayout()
...
# Layout: Round Block
cmds.frameLayout(collapsable = True, label = 'Round Block', width = 475)
cmds.columnLayout()
...
cmds.frameLayout(collapsable = True, label = 'Thin Jumper Block', width = 475)
cmds.columnLayout()
...
# Layout: Corner Block
cmds.frameLayout(collapsable = True, label = 'Corner Block', width = 475)
cmds.columnLayout()
...
# Layout: Shelf Block
cmds.frameLayout(collapsable=True, label='Shelf Block', width=475)
cmds.columnLayout()
...
cmds.frameLayout(collapsable=True, label='Four Bump Block', width=475)
cmds.columnLayout()
...
cmds.frameLayout(collapsable=True, label='Six Bump Block', width=475)
cmds.columnLayout()
